...
GRAPH _initial[NUM_VERTICES] = {
	0.5f, 0.35f, 0.2f, 0.0f, LINK, 1, 3, 7,
	-.5f, 0.35f, 0.2f, 0.0f, LINK, 2, 0, 6,
	-.5f, 0.35f, -.5f, 0.0f, LINK, 3, 1, 5,
	0.5f, 0.35f, -.5f, 0.0f, LINK, 0, 2, 4,
	0.5f, -.3f, -.5f, 0.0f, LINK, 5, 7, 3,
	-.5f, -.3f, -.5f, 0.0f, LINK, 6, 4, 2,
	-.5f, -.3f, 0.2f, 0.0f, LINK, 7, 5, 1,
	0.5f, -.3f, 0.2f, 0.0f, LINK, 4, 6, 0
};
// initial description
/*GRAPH _initial[NUM_VERTICES] = {
...
void interpolation(GRAPH * _graph, int a, int b, float t) {
	...
	//int slice = (int)((point[2] + 0.5f)*256);//64);
...
void draw(GRAPH * _graph) {
	...
	for (t = init; t >= end; t -= SPACING) 
	{
		...
		glVertexAttribPointer(ATTRIB_VERTEX, 3, GL_FLOAT, false, 0, vertices);
        glEnableVertexAttribArray(ATTRIB_VERTEX);
		
		glVertexAttribPointer(ATTRIB_TEXCOORD, 3, GL_FLOAT, 0, 0, texCoords);
